...
public class PTra13_09 {
	...
	public static void main(String[] args) {
		...
		employee1.userNm = NAMEDATA[0];
		employee1.mail = MAILDATA[0];
		employee1.password = PASSDATA[0];
		employee1.setDepartmentNm(QUATERDATA[0][0]);
		//employee1.setDepartmentCnt(QUATERDATA[1][0]);
		System.out.println(employee1.userNm,employee1.mail,employee1.password,employee1.getDepartmentNm());
		...
		employee3.setDepartmentNm(QUATERDATA[1][2]);
		System.out.println();
